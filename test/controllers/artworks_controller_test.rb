...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { artist: @artwork.artist, description: @artwork.description, name: @artwork.name, year: @artwork.year } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { artist: @artwork.artist, description: @artwork.description, name: @artwork.name, year: @artwork.year } }
